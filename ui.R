...
overview_tab <- tabPanel("Project Overview", fluidPage(
  ...
  p("Our datasets can be found here: [US Educational Finances](https://www.kaggle.com/datasets/noriuk/us-educational-finances) & [US County Population Data](https://www.nber.org/research/data/us-intercensal-county-population-data-age-sex-race-and-hispanic-origin)."),
